...
public class BancoController {
    ...
    public String FormActivity(String titulo, String autor, String editora){
        ...
        valores.put(CriaBanco.CPF, autor);
        valores.put(CriaBanco.TELEFONE, editora);
    ...
    public Cursor carregaDadoById(int id){
        Cursor cursor;
        String[] campos =  {banco.ID,banco.NOME,banco.CPF,banco.TELEFONE};
    ...
    public void alteraRegistro(int id, String nome, String CPF, String telefone){
        ContentValues valores;
        String where;
